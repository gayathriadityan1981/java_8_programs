...
public class GroupingByGender {
        ...
        public static void main(String args[]){
            GroupingByGender groupingByGender = new GroupingByGender();
        List<Employee> employees = groupingByGender.getEmployeeList();
        Map<String,Long> groupByGender = employees.stream().collect(Collectors.groupingBy(Employee::getGender,Collectors.counting()));
            System.out.println("No of male & female Employees : "+groupByGender);
        }
    }
